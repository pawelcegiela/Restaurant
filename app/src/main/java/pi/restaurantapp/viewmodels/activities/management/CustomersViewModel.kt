...
/**
 * Class responsible for presentation logic and binding between data/model and view (ViewModel layer) for Customers activity.
 * @see pi.restaurantapp.ui.activities.management.CustomersActivity View layer
 */
class CustomersViewModel : AbstractActivityViewModel() {
