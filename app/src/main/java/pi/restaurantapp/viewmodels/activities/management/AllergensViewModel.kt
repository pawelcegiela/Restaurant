...
/**
 * Class responsible for presentation logic and binding between data/model and view (ViewModel layer) for Allergens activity.
 * @see pi.restaurantapp.ui.activities.management.AllergensActivity View layer
 */
