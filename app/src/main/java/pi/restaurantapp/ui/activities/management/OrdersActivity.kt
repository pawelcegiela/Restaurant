...
/**
 * Class responsible for direct communication and displaying information to the user (View layer) for OrdersActivity
 * @see pi.restaurantapp.viewmodels.activities.management.OrdersViewModel ViewModel layer
 */
