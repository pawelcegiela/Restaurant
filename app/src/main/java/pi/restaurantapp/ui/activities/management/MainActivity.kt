...
import pi.restaurantapp.databinding.ActivityMainBinding

/**
 * Class responsible for direct communication and displaying information to the user (View layer) for MainActivity
 */
