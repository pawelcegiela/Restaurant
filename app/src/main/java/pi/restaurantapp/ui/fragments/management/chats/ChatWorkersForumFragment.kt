...
import pi.restaurantapp.viewmodels.fragments.management.chats.ChatWorkersForumViewModel

/**
 * Class responsible for direct communication and displaying information to the user (View layer) for ChatWorkersForumFragment.
 ...
 */
class ChatWorkersForumFragment : Fragment() {
    private var _binding: FragmentChatClientManagementBinding? = null
    private val binding get() = _binding!!

    private val viewModel: ChatWorkersForumViewModel by viewModels()
