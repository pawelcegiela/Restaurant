...
Z powodu ograniczeń w przesyłaniu plików do systemu APD (maksymalnie 20 MB na plik) część plików została zamieszczona w formie
podzielonego na pliki archiwum ZIP. W celu pracy z plikami - np. uruchamiania ich - najlepiej pobrać do jednego folderu wszystkie
pliki dołączone do pracy i wypakować wszystkie archiwa ZIP. Po wypakowaniu w folderze powinny znajdować się katalogi Kod i
Dokumentacja oraz skompilowany plik APK.
...
2. Instalacja środowiska Android Studio i kompilacja projektu:
...
(instalując wszystkie wybrane domyślnie komponenty: Android SDK, API 33, Performance i Android Virtual Device). Krok 4:
