...
import pi.restaurant.management.adapters.PreviewDishIngredientRecyclerAdapter
...
class PreviewDishFragment : AbstractPreviewItemFragment() {
    ...
    private fun initializeRecyclerViews(item: Dish) {
        ...
        SubItemUtils.setRecyclerSize(binding.recyclerViewPossibleIngredients, possibleIngredients.size, requireContext())
